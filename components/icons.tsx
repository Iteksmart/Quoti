...
export const ThinkingDotsIcon: React.FC<IconProps> = ({ className }) => (
    <div className={`flex space-x-1 p-2 ${className}`}>
...
export const ChatBubbleBottomCenterTextIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 12.75H6M15 15.75H9" />
...
export const Cog6ToothIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12a7.5 7.5 0 0015 0m-15 0a7.5 7.5 0 1115 0m-15 0H3m18 0h-1.5m-15.045-4.122L3.75 7.625m16.5 0l-1.299 2.25m-13.905-2.25L7.625 3.75m8.75 16.5l2.25-1.299M3.75 16.375l2.25-1.299m13.905 2.25L16.375 20.25m-8.75-16.5L12 3m0 18v-1.5m0 0a3 3 0 003-3m-3 3a3 3 0 00-3-3m3 3a3 3 0 013-3m-3 3a3 3 0 01-3-3m0 0a3 3 0 00-3-3m3 3a3 3 0 003-3m0 0a3 3 0 013 3m0 0a3 3 0 01-3-3m-3-3a3 3 0 00-3 3m0 0a3 3 0 01-3 3m3 3a3 3 0 003-3m-3 3a3 3 0 013-3" />
  </svg>
);
...
export const LinkedinIcon: React.FC<IconProps> = ({ className }) => (
  <svg fill="currentColor" viewBox="0 0 24 24" className={className}>
    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.3c-.966 0-1.75-.783-1.75-1.75s.784-1.75 1.75-1.75 1.75.783 1.75 1.75-.784 1.75-1.75-1.75zm13.5 12.3h-3v-5.6c0-1.33-.024-3.04-.5-4.34-1.292-1.3-1.875-.825-2.25.025-.375.85-.475 2.05-.475 3.315v6.6h-3v-11h3v1.5c.448-.849 1.55-1.65 3.25-1.65 3.475 0 4.125 2.288 4.125 5.25v6.4z" />
  </svg>
);

export const MapIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m0 0v2.25m0-2.25h1.5m-1.5 0h-1.5m-1.5 0V6.75m1.5 0v3.75m-1.5-3.75h1.5m-1.5 0h-1.5m16.5 0h-1.5m-1.5 0v3.75m1.5-3.75v-2.25m0 2.25h-1.5m1.5 0h1.5M12 6.75v3.75m0-3.75h1.5m0 0h-1.5m-1.5 0v3.75m0-3.75h-1.5m0 0h1.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 15m-1.5 1.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM15 15m-1.5 1.5a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z" />
  </svg>
);
